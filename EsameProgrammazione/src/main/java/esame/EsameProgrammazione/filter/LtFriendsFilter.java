...
/**
 * Classe che effettua il filtraggio degli amici ("friends"), tramite l'operatore "$lt"
 * 
 * @author Colucci Antonio
 * @author Andreozzi Carmen
 */
public class LtFriendsFilter extends FilterParent implements Filter{
	 ...
	 * @param parametro
	 */
	public LtFriendsFilter(Object parametro) {
		super(parametro);
	}
