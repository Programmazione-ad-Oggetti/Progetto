...
/**
 * Classe che effettua il filtraggio degli amici ("friends"), tramite l'operatore "$gte"
 * 
 * @author Colucci Antonio
 * @author Andreozzi Carmen
 */
public class GteFriendsFilter extends FilterParent implements Filter{
	 ...
	 * @param parametro
	 */
	public GteFriendsFilter(Object parametro) {
		super(parametro);
	}
